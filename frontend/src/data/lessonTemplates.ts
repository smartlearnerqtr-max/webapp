...
export const SUBJECT_TEMPLATES: Record<LessonLevel, LessonTemplate[]> = {
  ...
  trung_binh: [
    ...
    },
    {
      ...
      subject_name: 'Toán học',
      icon: '🔢',
      title: 'Số hữu tỉ và Hình khối',
      theme: 'Số học và Hình học',
      description: 'Làm quen with số hữu tỉ và phân loại các hình lăng trụ, hình chóp đơn giản.',
      h1: {
    ...
    },
    {
      ...
      subject_name: 'Khoa học tự nhiên',
      icon: '🔬',
      title: 'Nam châm, Ánh sáng và Nguyên tử',
      theme: 'Vật lý và Hóa học cơ bản',
      description: 'Khám phá các hiện tượng vật lý qua thí nghiệm ảo sinh động.',
      h1: {
    ...
    },
    {
      ...
      subject_name: 'Công nghệ',
      icon: '⚙️',
      title: 'Cây trồng, Vật nuôi và Nông cụ',
      theme: 'Nông nghiệp cơ bản',
      description: 'Tìm hiểu về quy trình trồng cây và các loại dụng cụ nông nghiệp.',
      h1: {
