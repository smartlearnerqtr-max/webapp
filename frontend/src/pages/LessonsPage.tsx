...
import type { TeacherLessonTemplate } from './lessonsPageTemplates'
...
export function LessonsPage() {
  ...
  const [activeTeacherTemplates, setActiveTeacherTemplates] = useState<TeacherLessonTemplate[]>([])
  ...
  useEffect(() => {
    ...
    void import('./lessonsPageTemplates')
      .then((module) => {
        if (cancelled) return
        setActiveTeacherTemplates(module.getLessonTemplatesByLevel(activeLessonLevel))
      })
      .finally(() => {
        if (!cancelled) {
      ...
      <div className="page-stack teacher-clean-page">
        ...
        <section className="lessons-workspace">
          ...
          <article className="roadmap-panel">
            ...
            {isTemplateCatalogLoading ? <p className="helper-text">Đang tải thư viện mẫu...</p> : null}
            {!isTemplateCatalogLoading && !activeTeacherTemplates.length ? <p className="helper-text">Chưa có bài mẫu cho mức này.</p> : null}
                      ...
                      <>
                        ...
                        <div className="lesson-preview-shell">
                          <LazyActivityCard
                            ...
                            loadingLabel="Đang tải xem trước hoạt động..."
                          />
                        </div>
